...
public class TrialSplashScreen92a91614687e400e9c6c61cd65cd4e1e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen92a91614687e400e9c6c61cd65cd4e1e.this, navigationdrawer.MainActivity.class);
