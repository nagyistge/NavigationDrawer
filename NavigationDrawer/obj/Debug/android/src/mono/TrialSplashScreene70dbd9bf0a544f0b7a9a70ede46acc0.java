...
public class TrialSplashScreene70dbd9bf0a544f0b7a9a70ede46acc0 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreene70dbd9bf0a544f0b7a9a70ede46acc0.this, navigationdrawer.MainActivity.class);
