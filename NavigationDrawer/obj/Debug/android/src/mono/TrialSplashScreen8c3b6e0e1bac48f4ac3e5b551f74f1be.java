...
public class TrialSplashScreen8c3b6e0e1bac48f4ac3e5b551f74f1be extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen8c3b6e0e1bac48f4ac3e5b551f74f1be.this, navigationdrawer.MainActivity.class);
