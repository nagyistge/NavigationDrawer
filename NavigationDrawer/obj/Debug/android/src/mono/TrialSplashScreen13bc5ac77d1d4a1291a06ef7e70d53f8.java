...
public class TrialSplashScreen13bc5ac77d1d4a1291a06ef7e70d53f8 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen13bc5ac77d1d4a1291a06ef7e70d53f8.this, navigationdrawer.MainActivity.class);
